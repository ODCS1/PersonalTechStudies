# 8. Escreva um programa em Python que exiba na tela a posição mais a esquerda de um dado 
...
def mostrarResultado(op):
    valor = str(lista[op])[0]
    print()
    print(f"LISTA: {lista}")
    print(f"Valor mais a esquerda para o elemento {lista[op]} na posição {op}: {valor}")
    print()
